...
import image1 from 'assets/boost-1-1.svg';
          ...
          <Flex sx={styles.col}>
            <Box sx={styles.content}>
              <Box sx={styles.titleBox}>
                <Heading as="h3">
                  Unlock Success with Tastrix
                </Heading>
                <Text as="p">
                "Supercharge Your Restaurant's Success with Tastrix: Elevate Efficiency and Customer Satisfaction!"
                </Text>
              </Box>
