...
const VideoOne = () => {
  ...
  return (
    <Box as="section" sx={styles.video}>
      <Container>
        <Heading as="h3">
        "Experience the Magic: Watch Our Awesome <br/> Tastrix Demo Video!"
        </Heading>
        <Text as="p">
        Explore how Tastrix revolutionizes restaurant management, streamlining operations,<br/>
         enhancing customer experiences, and boosting efficiency. 
        </Text>
